'''
Configuration script for DREAM-RNN_Human_K562 Predictor
...
- Inside container:             "DREAM-RNN_Human_K562_20251128-180629_TZ"  (sortable, human-readable)
- Outside container (Dev mode): "DREAM-RNN_Human_K562_dev"
'''
...
# Model Name
MODEL_NAME = "DREAM-RNN_Human_K562"
